...
@section('title', 'Laporan Perhitungan PPh 21')

@section('contents')
<div class="container d-flex justify-content-center">
    <div class="card border-0 shadow-sm rounded mb-4" style="width: 100%; max-width: 500px;">
        <div class="card-body">
            <h4 class="mb-4 text-center">Laporan Perhitungan PPh 21</h4>
            ...
            <form action="{{ route('perhitungan-pph.cetak') }}" method="GET">
                ...
                <div class="form-group d-grid gap-2 mb-2">
                    <button type="submit" name="preview" value="true" class="btn btn-warning" style="background-color: rgb(158, 154, 100); border-color: rgb(158, 154, 100);">
                        Lihat Laporan
                    </button>
                </div>
